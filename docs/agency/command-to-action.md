...
> 自己的误诊** —— 那七条的判据收进了 `HANDOFF.md` §2 §4,原文在
> `git show 3f5829e:docs/agency/handoff-2026-08-06.md` §3。
>
...
7. **吃/拉弓的自动释放陷阱真的会触发吗?** `Minecraft.java:2118-2123` 只做了括号核对,没观测。
   ...
   > 饭继续吃、弓继续拉,屏幕一关就射出去。原文见
   > `git show dcbe872:docs/agency/handoff-2026-08-04.md` §3①。
   >
