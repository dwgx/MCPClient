...
0. **任务是内核/游戏行动能力?先读 `agency/handoff-2026-08-08.md`**(最新交接 ——
...
| 文档 | 内容 | 状态 |
|---|---|---|
| `agency/handoff-2026-08-08.md` | **最新交接** —— 搭桥的全部真机测量(**客户端无速率门、服务端 reach 是 8 格不是 4.5、探针打不中一个 tick**)、MANEUVER 三通道锁相分析、**§0 活状态告警**、§4 一轮偏移的记录 | **接手先读这份** |
...
| 你想知道 | 去 |
|---|---|
| **接手内核任务,从哪开始** | `agency/handoff-2026-08-08.md`(最新;**§0 先看活状态告警**)→ `agency/handoff-2026-08-07.md`(§1 三条判据、§8.0 裁决)→ `agency/handoff-2026-08-06.md`(§3 真机七条、§7 诚实清单) |
