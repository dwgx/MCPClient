...
0. **任务是内核/游戏行动能力?先读 `agency/handoff-2026-08-06.md`**(最新交接),
   ...
   **D 仍未定而且它吞掉其余几个** —— 谁持有循环、以什么频率。
   ...
   > **然后回头读 `handoff-2026-08-05.md` 的 §3-§5**,它们没有被取代:七条空转断言、
...
| 文档 | 内容 | 状态 |
|---|---|---|
| `agency/handoff-2026-08-06.md` | **最新交接** —— LOOK 追踪不自终止(关键路径七步的最后一步)、effects 的"读不到"与"没有"分开、17 次变异表、mutate.py 及它自己被抓到的缺陷 | **接手先读这份** |
...
| 你想知道 | 去 |
|---|---|
| **接手内核任务,从哪开始** | `agency/handoff-2026-08-06.md`(最新;§0 是最要紧的三条,§1 是上一份已作废的几条) |
| **真机验证的两个环境陷阱(必读)** | `agency/handoff-2026-08-04.md` §5(08-03 那版已被订正) |
| **为什么"一条命令"还做不到、下一步做什么** | `agency/command-to-action.md` §0 §4 |
| **有哪些架构取舍在等我拍** | `agency/command-to-action.md` §5 —— 主要是 **Fork D**(模型持环 ~2Hz vs 代码持环 20Hz);另有 craft 的 L4 权限与那 8 个诚实墓碑删不删,见 `handoff-2026-08-06.md` §7 |
...
| **怎么证明一条断言不是空转** | `agency/handoff-2026-08-05.md` §3(方法)+ `agency/handoff-2026-08-06.md` §2③(`scripts/mutate.py`,含它自己被抓到的缺陷) |
