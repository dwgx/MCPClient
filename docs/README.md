...
0. **任务是内核/游戏行动能力?先读 `agency/handoff-2026-08-07.md`**(最新交接 ——
   §1 的三条判据是它最值得读的一节),再读 `agency/handoff-2026-08-06.md`(上一份,仍然
   有效:真机抓到的七条、craft 的缺口、六个 Fork),
...
| 文档 | 内容 | 状态 |
|---|---|---|
| `agency/handoff-2026-08-07.md` | **最新交接** —— 十一条空转断言(九条在安全内核与补丁签名链上,含**根文档授权自己的根**)、**§1 三条可复用判据**、并行只读审计 + 串行变异的形状 | **接手先读这份** |
...
| 你想知道 | 去 |
|---|---|
| **接手内核任务,从哪开始** | `agency/handoff-2026-08-07.md`(最新;§0 最要紧的三条,§1 三条判据)→ `agency/handoff-2026-08-06.md`(§3 真机七条、§7 诚实清单、§8 owner 待决) |
