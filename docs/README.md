...
0. **任务是内核/游戏行动能力?先读 `agency/handoff-2026-08-12.md`**(最新交接 ——
   ...
   **下一步是 `agency/telly-test-plan.md` 的 Phase 0**,没有别的东西挡着它。
   再读 `agency/handoff-2026-08-10.md`(59 条全空转的那一轮 + §9.1 **第四种判据形状:
   源码文本守卫**),再读 `agency/handoff-2026-08-09.md`(
   **`eval_java` 的实际边界:门是好的,门里面没有沙箱**;§4 那条 owner 待决
...
| `agency/mutation-candidates-2026-08-05.json` | 12 个子系统的 72 个变异候选。**全部跑完且全部修完:0 条待修**(每条带 `secondPassVerdict` + `fixed`)。累计 **70 SURVIVED → 70 CAUGHT**;1 条锚点被 `109e61a` 作废、从未跑过 | **已结清** |
