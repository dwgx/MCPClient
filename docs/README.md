...
| 文档 | 内容 | 状态 |
|---|---|---|
| `agency/handoff-2026-08-06.md` | **最新交接** —— 三个探针真机 38/38(**对角线第一次到达**)、真机抓到的七条(含**两次我自己的误诊**)、LOOK 追踪、effects/entities 的"读不到 vs 没有"、craft 活窗口、35 次变异表 | **接手先读这份** |
...
| **怎么证明一条断言不是空转** | `agency/handoff-2026-08-05.md` §3(方法)+ `agency/handoff-2026-08-06.md` §2④(`scripts/mutate.py`,含它自己被抓到的缺陷)+ §4(35 次变异表,含三条一开始 SURVIVED 的) |
