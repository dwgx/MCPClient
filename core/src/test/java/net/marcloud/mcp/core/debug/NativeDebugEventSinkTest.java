 ...
 * {@link DebuggerBridge#onDebugEvent} that the JVMTI callback thread invokes: it
...
public class NativeDebugEventSinkTest {
    ...
    public void onDebugEventForwardsToTheProcessQueueWithCorrectKind() {
        ...
        DebuggerBridge.onDebugEvent(3, Thread.currentThread(),
    ...
    public void unknownKindIntDegradesToUnknownNotACrash() {
        ...
        DebuggerBridge.onDebugEvent(999, Thread.currentThread(), "x", 0L);
