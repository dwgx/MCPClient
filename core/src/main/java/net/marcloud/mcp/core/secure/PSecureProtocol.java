 ...
 * exactly like {@link net.marcloud.mcp.core.mcp.SocketTransportServer} but with a
 ...
 * net.marcloud.mcp.core.security.PolicyEngine} + subject and returns the verdict.
 ...
 */
public final class PSecureProtocol {

    private PSecureProtocol() {
    }
