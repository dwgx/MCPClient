...
/**
 * C7 MCP tool: eval_ephemeral. Thin wrapper over {@link EphemeralSynthesizer},
...
public final class SynthTools {
    ...
    private final EphemeralSynthesizer synth;

    public SynthTools(EphemeralSynthesizer synth) {
        this.synth = synth;
    }
    ...
    private SyncToolSpecification evalEphemeral() {
        ...
        return new SyncToolSpecification(tool, (exchange, request) -> {
            ...
            EphemeralSynthesizer.EvalResult result = synth.eval(className, source, args);
            if (!result.success()) {
