 ...
 * returns false and put* throw {@link MmAccessException}.
 */
final class UnsafeAccess {
    ...
    void putInstance(Object t, Field f, Object value) {
        if (!available()) {
            throw new MmAccessException("Unsafe unavailable; final-field write not possible");
        }
        try {
            ...
            throw new MmAccessException("Unsafe putInstance failed: " + e.getMessage(), e);
        }
    }
    ...
    void putStatic(Field f, Object value) {
        if (!available()) {
            throw new MmAccessException("Unsafe unavailable; static-final write not possible");
        }
        try {
            ...
            throw new MmAccessException("Unsafe putStatic failed: " + e.getMessage(), e);
        }
    }
}
