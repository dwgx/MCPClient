 ...
 *       net.marcloud.mcp.core.ke.event.events.PacketReceivedEvent}</li>
 ...
 */
public final class FltManager implements HookSource {
    ...
    public FltManager(EventBus bus) {
        this.bus = bus;
    }
     ...
     * machinery. Delegates to {@link SeProtectedObjects#isProtected} so the
