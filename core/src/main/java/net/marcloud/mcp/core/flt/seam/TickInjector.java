 ...
 * net.marcloud.mcp.core.ke.event.events.TickEvent} every game tick. Uses Byte
 * Buddy's {@link AgentBuilder} with retransformation to inline {@link
 * TickAdvice} at the method entry.
 *
 * <p>Mirrors {@link net.marcloud.mcp.core.flt.FltManager}'s pattern:
...
public final class TickInjector {
     ...
     *  (the C3 FltDynamicManager pattern) — NOT discarded, so seam_tick_disable
