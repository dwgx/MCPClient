 ...
 * CAP_INTROSPECT_READ), wrapping {@link IntrospectionService}.
 */
public final class IntrospectionTools {

    private final IntrospectionService svc;

    public IntrospectionTools(IntrospectionService svc) {
        this.svc = svc;
    }
    ...
    private SyncToolSpecification listHooks() {
        Tool tool = Tool.builder()
                ...
                .description("List all runtime hooks: the target class/method, the advice class, "
                        ...
                        + "installed. Aggregates from all hook sources (HookManager, and future "
                        + "DynamicHookManager).")
