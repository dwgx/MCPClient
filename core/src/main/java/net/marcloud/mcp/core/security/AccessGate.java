...
/**
 * L4/L5 security contract: capability-SID + privilege gate for DeepAccess
 * operations. Each mutating DeepAccess method calls {@code require()} before
 ...
 * DeepAccess unblocked while that lands.
 *
