 ...
 * wrappers over {@link MmAccess}, handling arg parsing, game-thread marshalling,
...
public final class MutateStateTools {
    ...
    private final MmAccess deepAccess;
    private final RootResolver roots;

    public MutateStateTools(MmAccess deepAccess, RootResolver roots) {
        this.deepAccess = deepAccess;
        this.roots = roots;
        // Wire RootResolver back to MmAccess for path resolution
     ...
     * RootResolver(game))}.
     */
    public MutateStateTools(MmAccess deepAccess, net.marcloud.mcp.core.GameAccess game) {
    ...
    private SyncToolSpecification readField() {
        Tool tool = Tool.builder()
                ...
                .description("KERNEL (R0): read a field (including private) from a live object or "
                        ...
                        + "field). Protected values (Instrumentation, SeClearancePolicy internals) are "
    ...
    private SyncToolSpecification writeField() {
        Tool tool = Tool.builder()
                ...
                .description("HYPERVISOR (R-1): write a field (including private/final) on a live "
                        ...
                        + "object. Refuses protected classes (SeClearancePolicy, Ring, "
                        + "IoManager). HONEST LIMIT: final writes have no JMM visibility "
     ...
     * Prevents leaking the Instrumentation handle or SeClearancePolicy internals.
     */
    private boolean isProtectedValue(Object value) {
        ...
        return net.marcloud.mcp.core.se.SeProtectedObjects.isProtected(value.getClass().getName());
    }
}
