package net.marcloud.mcp.core.action;
 ...
 * {@link MainThreadExecutor}, because MC's networking and world state are not
 * thread-safe.
 *
...
public final class ActionManager {
    ...
    private final MainThreadExecutor exec;
    private final long defaultTimeoutMillis;

    public ActionManager(GameAccess game, MainThreadExecutor exec) {
        this(game, exec, 5000L);
    }

    public ActionManager(GameAccess game, MainThreadExecutor exec, long defaultTimeoutMillis) {
        this.game = game;
        this.exec = exec;
