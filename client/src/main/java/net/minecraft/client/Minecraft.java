...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    {
        // Twitch streaming (tv.twitch SDK) is a dead service and its natives are
        // removed in this port. TwitchStream would always fail into NullStream,
        // so go straight to NullStream — same effective behavior, no error spam.
