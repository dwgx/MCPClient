...
public class PacketBuffer extends ByteBuf
{
    ...
    public String readStringFromBuffer(int maxLength)
    {
        ...
        {
            // Netty 4.1 + LWJGL3 gives us pooled DIRECT buffers, whose .array()
            // throws UnsupportedOperationException. Read into a byte[] instead,
            // which works for both direct and heap buffers.
            byte[] stringBytes = new byte[i];
            this.readBytes(stringBytes);
            String s = new String(stringBytes, Charsets.UTF_8);
    ...
    // ==== Netty 4.1 added abstract ByteBuf methods (delegated to this.buf) ====
    ...
    public CharSequence getCharSequence(int index, int length, java.nio.charset.Charset charset)
    {
    ...
    public int setCharSequence(int index, CharSequence sequence, java.nio.charset.Charset charset)
    {
    ...
    public CharSequence readCharSequence(int length, java.nio.charset.Charset charset)
    {
    ...
    public int writeCharSequence(CharSequence sequence, java.nio.charset.Charset charset)
    {
