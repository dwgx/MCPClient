            ...
            if (bytebuf.readUnsignedByte() == 254)
            {
                ...
                switch (i)
                {
                    ...
                    default:
                        ...
                        byte[] pingHostBytes = new byte[bytebuf.readShort() * 2];
                        bytebuf.readBytes(pingHostBytes);
                        flag1 = flag1 & "MC|PingHost".equals(new String(pingHostBytes, Charsets.UTF_16BE));
                        int j = bytebuf.readUnsignedShort();
                        flag1 = flag1 & bytebuf.readUnsignedByte() >= 73;
                        int hostLen = bytebuf.readShort() * 2;
                        bytebuf.skipBytes(hostLen);
                        flag1 = flag1 & 3 + hostLen + 4 == j;
